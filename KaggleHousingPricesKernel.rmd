...
We have 43 categorical variables, some of them have only few levels. We will try to reduce the number of them by visualizing them. 

- First look at which features are redundant, i.e: does not explain sensible amount of variability in the SalePrice, 