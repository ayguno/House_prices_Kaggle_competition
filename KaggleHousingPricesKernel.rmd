...
```{r}
test.processed[which(is.na(test.processed)),which(apply(is.na(test.processed), 2, sum) != 0 )]
```

# Building models using training set 

## Fitting a lasso regression model to data

```{r,eval=FALSE}

# Need to deal with the missing data first!!
